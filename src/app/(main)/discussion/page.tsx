...
const forumCategories = [
  {
    ...
    icon: <QuizIcon />,
    color: "#007BFF",
    description: "Discuss questions, logic, and insights from career quizzes",
  },
  {
    ...
    icon: <AssessmentIcon />,
    color: "#6A0DAD",
    description: "Interpret and compare personalized career/skill reports",
  },
  {
    id: "career-explorer",
    ...
    icon: <ExploreIcon />,
    color: "#FF7A00",
    description: "Explore roles, pathways, and industry insights",
  },
  {
    id: "pdf-downloads",
    name: "PDF Downloads",
    ...
    color: "#28a745",
    description: "Share and troubleshoot exported PDFs & resources",
  },
  {
    id: "subject-stream",
    name: "Subject Stream R",
    icon: <SchoolIcon />,
    color: "#E91E63",
    description: "Discuss subject stream recommendations & choices",
  },
  {
    id: "success-stories",
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      <Box sx={{display: 'flex', justifyContent: 'flex-end'}}>
        <Box>
          <Button variant="contained" onClick={() => setOpenNewThread(true)} sx={{ mb: 2 }}>
            Begin a Discussion
          </Button>
        </Box>
      </Box>
